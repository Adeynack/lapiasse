...
// BookCreate defines model for Book.Create.
type BookCreate struct {
	DefaultCurrencyIsoCode string `json:"default_currency_iso_code"`
	Name                   string `json:"name"`
}

// BookIndex defines model for Book.Index.
...
// BookUpdate defines model for Book.Update.
